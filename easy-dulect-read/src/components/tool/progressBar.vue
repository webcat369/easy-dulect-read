  ...
  methods: {
    addListener () {
      ...
      slider.ontouchstart = (e) => {
        ...
        distance = e.touches[0].pageX - curX // 得出绝对距离
        // console.log(curX)
      ...
      progress.ontouchmove = (e) => {
        ...
        if (isClickSlider) {
          // 判断是否已经超出进度条的长度
          if ((e.touches[0].pageX - distance) >= 0 && (e.touches[0].pageX - distance) <= (this.width - 0)) {
            this.sliderLeft = e.touches[0].pageX - distance
